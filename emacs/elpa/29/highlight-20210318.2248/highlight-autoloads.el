;;; highlight-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn START-EVENT &optional FACE-NB)" t)
...
Same as `hlt-highlighter', but for binding to a menu item." t)
(autoload 'hlt-eraser-mouse "highlight" "\
Same as `hlt-eraser', but for binding to a menu item." t)
...
(fn &optional START END FACE MSGP MOUSEP BUFFERS)" t)
...
(fn REGEXP BUFFERS &optional FACE MSGP MOUSEP NTH)" t)
...
(fn &optional START END REGEXP FACE MSGP MOUSEP NTH BUFFERS)" t)
...
(fn REGEXP BUFFERS &optional NTH MSGP)" t)
...
(fn REGEXP &optional FACE MSGP MOUSEP NTH)" t)
...
(fn &optional START END REGEXP MSGP MOUSEP)" t)
...
(fn FACE BUFFERS &optional MSGP)" t)
...
(fn &optional FACE START END MSGP MOUSEP BUFFERS)" t)
...
(fn OLD-FACE NEW-FACE BUFFERS &optional MSGP)" t)
...
(fn OLD-FACE NEW-FACE &optional START END MSGP MOUSEP BUFFERS)" t)
...
(fn SYMBOL &optional ALL-BUFFERS-P FACE)" t)
...
(fn &optional START END FACE MSGP)" t)
...
If the current value is nil, it is set to the last non-nil value." t)
...
(fn &optional POSITION ARG MSGP)" t)
...
(fn &optional FACE MSGP MOUSEP BUFFERS STRING)" t)
...
(fn &optional FACE MSGP MOUSEP BUFFERS STRING)" t)
(register-definition-prefixes "highlight" '("hlt-"))

;;; End of scraped data

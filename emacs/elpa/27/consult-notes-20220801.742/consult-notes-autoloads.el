;;; consult-notes-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-notes" '("consult-notes-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-notes-org-roam" '("consult-notes-org-roam-")))

...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "denote-dired" '("denote-dired-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "denote-faces" '("denote-faces-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "denote-link" '("denote-link-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "denote-org-capture" '("denote-org-capture-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "denote-retrieve" '("denote-retrieve--")))

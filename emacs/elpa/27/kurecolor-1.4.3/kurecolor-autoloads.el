...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "etd" '("create-docs-file" "def" "docs--" "etd-testing" "example" "first-three" "function" "github-id" "goto-and-remove" "quote-" "simplify-quotes")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "kurecolor" '("kurecolor-")))

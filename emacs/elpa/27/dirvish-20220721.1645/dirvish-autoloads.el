...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-bookmark" '("dirvish-bookmark-entries")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-media" '("dirvish-media-")))
